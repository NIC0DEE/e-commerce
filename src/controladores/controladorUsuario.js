...
const bcrypt = require('bcryptjs'); //función hash de cifrado
...
exports.registrarUsuario = async (req, res) => {
    ...
    try {
        ...
        const resultado = await pool.query(
            ...
            [nombre, correo, hashedPassword, direccion, telefono, rol || 'cliente'] // cliente como valor por defecto
        );
...
exports.iniciarSesion = async (req, res) => {
    ...
    try {
        ...
        const token = jwt.sign({ id: usuario.id, rol: usuario.rol }, process.env.JWT_SECRET, { expiresIn: '1h' }); //genera token
